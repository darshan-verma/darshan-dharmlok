...
import { HotelDharamshala, FormErrors } from "./types";
	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Update Hotel Dharamshala&apos;s personal details and contact information.
				</CardDescription>
			</CardHeader>
					...
					<div className="space-y-6">
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div className="space-y-2">
								...
								<p className="font-medium text-foreground">{HotelDharamshala?.name}</p>
							</div>
							<div className="space-y-2">
								<h3 className="text-sm font-medium text-muted-foreground">
									Email
