...
interface VideoTableProps {
	...
	onDeleteVideo: (id: string, title: string) => void;
									...
									<TableCell>
										<DropdownMenu>
											...
											<DropdownMenuContent align="end">
												<DropdownMenuLabel>Manage Video</DropdownMenuLabel>
												<DropdownMenuSeparator />
												<DropdownMenuSub>
													<DropdownMenuSubTrigger>
													...
													<DropdownMenuSubContent>
														<DropdownMenuItem
															onClick={() => onUpdateStatus(video.id, "Active")}
															className={
																video.status === "Active" ? "bg-blue-50" : ""
															}
														>
														...
														<DropdownMenuItem
															onClick={() =>
																onUpdateStatus(video.id, "Inactive")
															}
															className={
																video.status === "Inactive" ? "bg-blue-50" : ""
															}
														>
